...
export default function AdminMatchForm({ match, homeTeamName, awayTeamName, isNext }: Props) {
  ...
  return (
    <div className={`bg-slate-900 border rounded-xl p-4 ${
        ...
        {sets.map((s, i) => (
          <div key={i} className="flex items-center gap-2">
            ...
            <input
              ...
              placeholder="0"
              className="w-full bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-center text-sm font-mono font-bold text-slate-200 focus:outline-none focus:border-orange-400 disabled:opacity-40"
            />
      ...
      {hasTie && (
        <p className="flex items-center gap-1.5 text-orange-400 text-xs mb-2">
